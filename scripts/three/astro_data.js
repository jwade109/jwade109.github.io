...
const JUPITER_SMA = 5.2*AU;
const SATURN_SMA = 9.5*AU;
const URANUS_SMA = 19.2*AU;
const NEPTUNE_SMA = 30.1*AU;
...
const MERCURY_RADIUS = 0.38*R_E;
const VENUS_RADIUS = 0.95*R_E;
const JUPITER_RADIUS = 11.2*R_E;
const SATURN_RADIUS = 9.5*R_E;
